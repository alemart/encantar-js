"use strict";
/**
 * @file A-Frame plugin for encantar.js
...
(function() {
  ...
  AFRAME.registerComponent("ar-reference-image", ARComponent({
    ...
    referenceImage() {
      ...
      return {
        name: this.data.name != "" ? this.data.name : void 0,
        image: img
      };
    }
  }));
  ...
  AFRAME.registerComponent("ar-viewport", ARComponent({
    ...
    _fix(viewport) {
      this.el.sceneEl.addEventListener("arinspectortoggled", (ev) => {
        const AFRAME_INSPECTOR_ZINDEX = 999999;
