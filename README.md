...
* **Image tracking**: track detailed images such as cartoons or photos. Import your [custom images](https://encantar.dev/guidelines-for-images) and see that it just works! This is also known as Natural Feature Tracking.
